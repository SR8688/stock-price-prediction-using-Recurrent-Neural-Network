...
if __name__ == "__main__": 
	...
	with open('./models/scaler_RNN_model','wb') as file_pick:
	...
	lstm_out = model.fit(X_train,y_train,epochs=1500,batch_size=64,verbose=2)
	# 		Make sure to print your training loss within training to show progress
	# 		Make sure you print the final training loss
	print('The final training loss is ',lstm_out.history['loss'][-1])
	# 3. Save your model
	# Please uncomment the following line to save the model in the models directory
	#model.save('./models/20858688_RNN_model.h5')